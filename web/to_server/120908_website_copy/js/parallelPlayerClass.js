...
function testLoad (vpIdsStr) {
  ...
  document.addEventListener("DOMContentLoaded", function () {
    ...
    var clipList1 = [
      ...
      { src: "./content/video/jubilee/jubilee_07.webm", in: 20,  out: 30},
      { src: "./content/video/jubilee/jubilee_09.webm", in: 10,  out: 20},                                                              
    ];                                              
    var clipList2 = [                               
      ...
      { src: "./content/video/jubilee/jubilee_05.webm", in: 30,  out: 40},
      { src: "./content/video/jubilee/jubilee_03.webm", in: 10,  out: 20},
      { src: "./content/video/jubilee/jubilee_09.webm", in: 20,  out: 30},
      { src: "./content/video/jubilee/jubilee_01.webm", in: 30,  out: 40},
    ];
