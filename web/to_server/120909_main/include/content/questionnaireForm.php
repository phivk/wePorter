...
<form name="questionForm" id="questionForm" action="handle_form.php" method="post">
  ...
  <div class="row">
    <div class="six columns">
      ...
      <p>
        <label>How much time do you spend watching video online on an average day?</label>
      ...
      <p>
        <label>Are the videos you watch online related to current affairs (like news, public events, other recent events relating to the public interest)? Ranging from 1 being never, 3 about half of the time, 5 being always</label>
    ...
    <div class="six columns">   
       ...
       <p>
         <label>Did you experience the interaction as <strong>pleasant</strong>? Ranging from 1 being very unpleasant, 3 being neutral, 5 being very pleasant</label>
         <select name="formPleasant">
           <option value="000" disabled selected style='display:none'>Please Choose</option>
           <option value="1"> 1 </option>
           <option value="2"> 2 </option>
           <option value="3"> 3 </option>
       ...
       <p>
          <label>Did you experience the interaction as <strong>informative</strong>? Ranging from 1 being very uninformative, 3 being neutral, 5 being very informative</label>
          <select name="formInformative">
            <option value="000" disabled selected style='display:none'>Please Choose</option>
            <option value="1"> 1 </option>
            <option value="2"> 2 </option>
            <option value="3"> 3 </option>
        ...
        <p>
         <label>What, in your experience, caused you to change your focus from one video player to the other?</label>
         <textarea name="formFocus" rows="3" cols="25"></textarea>
        </p>
    </div> <!-- six columns -->
  </div> <!-- row -->
...
frmvalidator.addValidation("formPleasant", "dontselect=000","Please choose an option");
frmvalidator.addValidation("formInformative", "dontselect=000","Please choose an option");
frmvalidator.addValidation("formFocus","maxlen=500", "Please use 500 characters or less");
