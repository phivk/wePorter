<?php
  ...
  */
  ...
  class sequenceLoader
  {
    ...
    public $db_username = "philo";
    public $db_password = "thieu";
    // DEBUG
    // public $db_name = "tutorial";
    public $db_name = "philo";
    public $DEBUG = false;
    ...
    public function getHtmlFromSeqs($vpSeqs) {
      ...
      foreach($vpSeqs as $key => $seq) {
        ...
        foreach($seq as $vp) {
          ...
          // local files
          // $html .= '{
          //     src: "content/video/jubilee/jubilee_'.$srcStr.'.webm",
          //     in: '.$in.', 
          //     out: '.$out.'
      ...
      if ($this->DEBUG) {
        $html .= "console.log(player.getVpIds());";
      }
      if ($_SESSION['views'] > 1) {
