...
<html>
  <head>
    ...
    <script type="text/javascript" src="./js/context1.js"></script>
  </head>
  <body>
    <!-- run JS on load -->
    ...
    <!-- Main Content-->
        ...
        <div class="ten columns"> 
					...
					<div class="alert-box">
            <h4>Instructions</h4>
            <p>In this third experiment, you will be presented with two videos in parallel twice. Each of the videos are made up from different parts and take 30 seconds in total. In between there will be moment to pause.</p>
    ...
    <div id="contextModal1" class="reveal-modal">
      <h2>Thank you!</h2>
