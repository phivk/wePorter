...
<html>
  <head>
    ...
    <script type="text/javascript" src="./js/res1.js"></script>
  </head>
  <body>
    <!-- run JS on load -->
    ...
    <!-- Main Content-->
		...
		<div id="resModal" class="reveal-modal">
      <h2>The End</h2>
      <p>You can always play more at the main page</p>
      <p><a
        id = "contextButton2"
        href = "weporter.php"
        class="button">
