  ...
  <body>
    ...
    <!-- Main Content-->
	    ...
	    <div class="twelve columns">
					...
					<div class="alert-box">
            <h3>Instructions</h3>
            <p>In this experiment you will watch videos in pairs, one after the other. Videos are randomly positioned left and right. You will be asked to score the videos depending on how Informative and Entertaining you think they are. You will also be asked which of the two videos has your preference: which of the two would you rather watch?</p>
